...
class ColorPick extends StatefulWidget {
  ...
  const ColorPick(this.title, this.pickedColor, this.theme, {this.onSelectFunction,Key? key}) : super(key: key);
...
class _ColorPickState extends State<ColorPick> {
  ...
  static const double _svWidgetSize = 450;
  static const Size _hueWidgetSize = Size(50, _svWidgetSize);
  ...
  Widget build(BuildContext context) {
    ...
    var colorBoxSize = const Size(256, 64) * sizeConfig.safeBlockSmallest;
    return Row(
  ...
  Widget buildOverly(SizeConfig sizeConfig, AppThemeData appThemeData) {
    ...
    return SafeArea(
      child: Padding(
        padding: EdgeInsets.all(50.0* sizeConfig.safeBlockSmallest),
        child: Container(
          decoration: BoxDecoration(
            color: appThemeData.selectedTheme.primaryDarkColor,
            borderRadius: BorderRadiusDirectional.circular(50 * sizeConfig.safeBlockSmallest)
          ),
          child: Padding(
              padding: EdgeInsets.all(50.0 * sizeConfig.safeBlockSmallest),
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    Text("Color Picker", style: TextStyle(color: appThemeData.selectedTheme.textColor, fontSize: 128 * sizeConfig.safeBlockSmallest),),
                    SizedBox(height: 100 * sizeConfig.safeBlockSmallest,),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Text("Color:", style: TextStyle(color: appThemeData.selectedTheme.textColor, fontSize: 64 * sizeConfig.safeBlockSmallest)),
                            SizedBox(width: 20 * sizeConfig.safeBlockSmallest,),
                            Container(
                              padding: EdgeInsetsDirectional.all(2 * sizeConfig.safeBlockSmallest),
                              width: 100 * sizeConfig.safeBlockSmallest,
  ...
  Widget _SVPickerWidget(SizeConfig sizeConfig) {
    ...
    var pointerSize = 50 * sizeConfig.blockSmallest;
    return Stack(
      children: [
        Container(
          decoration: BoxDecoration(
