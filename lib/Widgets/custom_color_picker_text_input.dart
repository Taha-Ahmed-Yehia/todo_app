...
class CustomColorPickTextField extends StatelessWidget {
  ...
  {this.onSubmitted, this.onTapOutside, this.size = const Size(200, 50), this.inputType = TextInputType.number, super.key}) {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle textStyle = TextStyle(color: theme.textColor, fontSize: 32 * sizeConfig.safeBlockSmallest);
